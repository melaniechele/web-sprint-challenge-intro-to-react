...
A side effect is something that affects things outside of the current function that is being executed. We can use the useEffect hook to manage side effects.
